                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="payment" data-parent="#accordionExample">
                            ...
                            <li>
                                <a href="{{route('admin.payments.create')}}" target="">Payment List</a>
                            </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="starter-kit" data-parent="#accordionExample">
                            <li>
                                <a href="{{route('admin.upcoming_sale')}}"> Upcoming Sale </a>
                            </li>
                            {{-- <li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="list" data-parent="#accordionExample">
                            ...
                            <li>
                                <a href="{{route('admin.contactUsList')}}" target=""> Contact Us List </a>
                            </li>
                                {{--<li>
                                <a href="auth_login.html" target=""> Login Cover </a>
                            </li>
